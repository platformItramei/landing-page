      ...
      <div className="pt-32 pb-20 px-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            {/* <div className="text-center mt-12 sm:mt-16 md:mt-20 bg-gradient-to-br from-gray-900/60 to-gray-800/40 backdrop-blur-sm border border-gray-700/40 rounded-xl sm:rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 premium-shadow">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <Button
                  className="text-white px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base md:text-lg font-semibold rounded-lg sm:rounded-xl micro-interaction premium-shadow"
                  style={{ background: "linear-gradient(to bottom, rgba(35,195,255,1), rgba(0,128,255,0.6))" }}
                >
                  Schedule a Demo
                </Button>
                <Button
                  className="bg-transparent hover:bg-purple-600/20 text-white px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base md:text-lg font-semibold rounded-lg sm:rounded-xl border border-gray-600 hover:border-purple-500 micro-interaction"
                >
                  Contact Sales
                </Button>
              </div>
